...
// Configuration for embedded systems - MUST be defined before including lfs.h
#define LFS_NO_ASSERT    // Disable assertions to prevent hang on startup
#define LFS_NO_DEBUG     // Disable debug output
#define LFS_NO_WARN      // Disable warning messages
